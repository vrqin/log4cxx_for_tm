...
void LocationInfo::write(ObjectOutputStream& os, Pool& p) const {
    if (lineNumber == -1 && fileName == NA && methodName == NA_METHOD) {
        ...
        char prolog[] = {
         ...
         0x6E, 0x49, 0x6E, 0x66, 0x6F, static_cast<logchar>(0xED), static_cast<logchar>(0x99), static_cast<logchar>(0xBB), 
         static_cast<logchar>(0xE1), 0x4A, static_cast<logchar>(0x91), static_cast<logchar>(0xA5), 0x7C, 0x02, 0x00, 0x01, 
